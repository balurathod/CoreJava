...
class BigOuter 
{
	static class Nest//why it is static? Bcz inner class may b static nested class.
	{                //but not only static class.
		void go()
		{
			System.out.println("Hi..!");
		}
	}
	//Nest n = new Nest(); why this define here.its active/unactive no effect on prog.
    //n.go();       //why & how?
}
class Broom
{
	...
	{
		BigOuter.Nest n1=new BigOuter.Nest();   //both class names
		n1.go();
		
	//	Broom.B2 b2=new Broom.B2();  //why this is not .
